...
- [✨ Key Features – What You Get](#-key-features--what-you-get)
  - [🚀 Plug & Play Virtual Machine](#-plug--play-virtual-machine)
  - [⚡ Simple Setup, Smart Automation](#-simple-setup-smart-automation)
  - [🧠 Customizable & Flexible](#-customizable--flexible)
  - [🖥️ Complete Linux Environment](#️-complete-linux-environment)
  - [🌐 Everything You Need, Preinstalled](#-everything-you-need-preinstalled)
  - [🧩 Guided “Get Started” Workflows](#-guided-get-started-workflows)
  - [🔗 Preinstalled JDBC Drivers & Connectors](#-preinstalled-jdbc-drivers--connectors)
  - [🛠️ Database Migration Made Easy](#️-database-migration-made-easy)
  - [⚙️ Post-Load Optimization Script](#️-post-load-optimization-script)
  - [🌎 Virtual Schema Adapters & Templates](#-virtual-schema-adapters--templates)
  - [🔢 Ready-to-Use Virtual Schemas](#-ready-to-use-virtual-schemas)
...
- [🧰 Requirements and Pre-Requisites](#-requirements-and-pre-requisites)
  ...
  - [⚙️ Recommended Hypervisor Versions](#️-recommended-hypervisor-versions)
    - [🪟🐧 For Windows (x86-64) and Linux (x86-64)](#-for-windows-x86-64-and-linux-x86-64)
    - [🍏 For macOS (Intel x86-64 only)](#-for-macos-intel-x86-64-only)
    - [🪟🍏🐧 For Windows, macOS (Intel x86-64 only), and Linux (x86-64)](#-for-windows-macos-intel-x86-64-only-and-linux-x86-64)

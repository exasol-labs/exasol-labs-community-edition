...
--
-- DB2 Virtual Schema Adapter Script:
...
-- Documentation: https://github.com/exasol/db2-virtual-schema/blob/main/doc/user_guide/db2_user_guide.md
--
...
-- See also: https://github.com/exasol/db2-virtual-schema/blob/main/doc/user_guide/db2_user_guide.md#defining-a-named-connection
--
...
--
CREATE VIRTUAL SCHEMA VS_DB2_MYSCHEMA
USING VS_ADAPTERS.DB2_ADAPTER WITH
    CONNECTION_NAME = 'DB2_JDBC'
...
-- a DB2 Virtual Schema to a small demo DB2 for you.
...
--
SELECT * FROM "VS_DB2_EXASOLDEMO"."CUSTOMERS";
SELECT * FROM "VS_DB2_EXASOLDEMO"."ORDERS";
SELECT * FROM "VS_DB2_EXASOLDEMO"."PRODUCTS";
--
--
